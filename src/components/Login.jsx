...
import React, { useState } from "react";
import { CloudArrowUpIcon } from "@heroicons/react/24/outline"; // ✅ added icon
import API from "../api"; // axios instance with baseURL set to https://bresume.onrender.com
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-black via-red-800 to-gray-900">
      <div className="bg-white p-8 rounded-lg shadow-xl w-96 animate-fadeIn">
        ...
        {/* Upload-style UI box */}
        <div className="border-2 border-dashed border-gray-400 rounded-xl p-6 text-center mb-6 hover:border-green-500 transition cursor-pointer bg-gray-50">
          <CloudArrowUpIcon className="mx-auto h-12 w-12 text-green-500 mb-3" />
          <p className="text-gray-700 font-medium">
            {isSignup ? "Sign up to start uploading resumes" : "Login to continue"}
          </p>
